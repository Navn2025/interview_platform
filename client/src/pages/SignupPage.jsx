    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-violet-100 p-4">
      ...
      <div className="relative w-full max-w-sm animate-slide-up">
        ...
        {/* Logo */}
          ...
          {/* Form */}
          <form onSubmit={handleSubmit} className="flex flex-col gap-4" id="signup-form" noValidate>
            <Input id="signup-name" label="Full Name" type="text" placeholder="Enter your full name"
              value={form.name} onChange={handleChange('name')} error={errors.name} required />
            <Input id="signup-email" label="Email Address" type="email" placeholder="your.email@example.com"
              value={form.email} onChange={handleChange('email')} error={errors.email} required />
            <div className="relative">
              <Input id="signup-password" label="Password" type={showPassword ? 'text' : 'password'}
                placeholder="Enter your password" value={form.password} onChange={handleChange('password')}
            ...
            <div className="flex gap-3 mt-1">
              <Button type="button" variant="secondary" fullWidth onClick={() => navigate('/')} id="signup-back">
                Back
              </Button>
              <Button type="submit" fullWidth disabled={loading} id="signup-continue">
                {loading ? (
